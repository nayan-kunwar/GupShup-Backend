...
const sendMessage = asyncHandler(async (req, res) => {
  ...
  chat.participants.forEach((participantObjectId) => {
    ...
    if (participantObjectId.toString() === req.user._id.toString()) return; //return inside a forEach only exits the current callback function (like a continue in normal loops).
